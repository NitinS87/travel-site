    ...
    <div className="max-w-[1400px] m-auto py-12 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="pb-6">
          ...
          ratione magnam natus autem accusantium. Ullam incidunt animi ducimus
          delectus et provident, itaque placeat dolorem repudiandae temporibus
          nobis, quo dolor facere.
        </p>
      </div>
      <div>
